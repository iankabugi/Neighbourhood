...
class HoodTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.hood = Neighbour(name='ghetto', location='locale', user=self.user)
    ...
    def test_update_method(self):
        ...
        """
        self.hood.save_hood()
        new_hood = Neighbour.objects.filter(name='ghetto').update(name='Bias')
...
class BusinessTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.hood.save_hood()
        self.biz = Business(
            name="bizna", email="kokoko@gmail.com", user=self.user, hood=self.hood)
